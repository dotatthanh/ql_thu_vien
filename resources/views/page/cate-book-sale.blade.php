	...
	<div class="container">
		<div class="list-item">
			<ul class="breadcrumb" itemscope="" itemtype="http://schema.org/BreadcrumbList">
				...
				<li itemprop="itemListElement" itemscope="" itemtype="http://schema.org/ListItem">
					<a itemprop="item"><span itemprop="name">Danh mục Sách đang khuyến mãi</span></a>
		...
		<div class="row">
						...
						<div class="col-md-4 col-sm-6 col-12 col-lg-3 pad10">
							<div class="book">
								<div class="book-img">
									...
									<span class="book-sale">- {{ $book->sale }}%</span>
								</div>
								<div class="book-info">
			...
			<div class="order-1 order-lg-12 col-md-12 col-sm-12 col-12 col-lg-4 cate-book-selling">
				<div class="search-cate-book">
					<form action="{{ route('page.category_sale') }}" method="GET">
